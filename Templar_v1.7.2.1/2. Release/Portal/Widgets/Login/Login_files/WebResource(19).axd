...
(function ($) {
    ...
    **/
    elRTE.prototype.save = function () {
		...
		this.source.closest('[id$=Settings]').find('[id$=btnSaveSettings]').trigger('click');
    }
...
(function ($) {
    elRTE.prototype.options = {
        ...
        toolbars: {
			...
			rte: ['save','copypaste', 'undoredo', 'style', 'alignment', 'direction', 'colors', 'format', 'indent', 'lists', 'links', 'elements', 'media', 'tables','templarButtons']
        },
        panelNames: {
            save: 'Save',
            copypaste: 'Copy/Pase',
...
(function ($) {
    elRTE.prototype.ui.prototype.buttons.help = function (rte, name) {
        ...
        this.command = function () {
            ...
            txt = '<div class="elrte-logo"></div><h3> <strong>Html Editor</strong></h3>'
				+ '<div class="elrte-ver">v1.0</div>'
				+ '<div class="elrte-ver">jQuery: ' + $('<div/>').jquery + '</div>'
				+ '<div class="elrte-ver">jQueryUI: ' + $.ui.version + '</div>'
				+ '<br clear="all"/><p>'
				+ 'HTML Editor is simple & easy to use  widget for rapid creation of pure html based pages in Templar.<br/>'
				+ 'Main goal of the editor - simplify work with text and formating (HTML) on sites.<br/>'
				+ '</p>'
				+ '<br clear="all"/><p>'
				+ '<h4><strong>For Substitution </strong></h4>'
				+ '<table class="elrte-authors">'
				+ '<tr><td>Templar Page Url</td><td>[$TemplarUrl(&lt;Relative Url&gt;)$]</td></tr>'
				+ '<tr><td>Theme Base Path</td><td>[$ThemeUrl(&lt;Theme relative path to file&gt;)$]</td></tr>'
				+ '<tr><td>Widget UniqueID</td><td>[$@@WidgetUniqueID$]</td></tr>'
				+ '<tr><td>Site Settings Value</td><td>[$SiteSettings(&lt;Group Name&gt;,&lt;Key&gt;)$]</td></tr>'
				+ '<tr><td>Page Settings Value</td><td>[$PageSettings(&lt;Key&gt;)$]</td></tr>'
				+ '<tr><td>Globalize Resource string</td><td>[#&lt;ResourceKey&gt;#]</td></tr>'
				+ '</table>'
				+ '<h4><strong>Values can be: </strong></h4>'
				+ '<div>Absolute Url e.g. http://anydomain/SampleJs.js</div>'
				+ '<div>Relative Url e.g. ~/Widgets/SampleJs.js</div>'
				+ '<div>SiteResource e.g. SiteResourceUrl("<ResourceName>")</div>'
            d = new elDialogForm(opts);
            d.append(txt);
            d.open();
        }
