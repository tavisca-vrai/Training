...
namespace SeleniumAutomation
{
    ...
    public class UnitTest1
    {
        ...
        public void HrLoginTest()
        {
            ...
            driver.Navigate().GoToUrl("http://localhost:61054/Login.aspx");
            driver.FindElement(By.Id("MainContent_LoginUserControl1_TextBox1")).SendKeys("isha@gmail.com");
            driver.FindElement(By.Id("MainContent_LoginUserControl1_TextBox2")).SendKeys("neil143");
            driver.FindElement(By.Name("ctl00$MainContent$LoginUserControl1$LoginButton")).Click();
            string currentURL = driver.Url;

            Assert.AreEqual(currentURL, "http://localhost:61054/HrPage.aspx");
        }
        ...
        public void LogoutSuccessfullTest()
        {
            ...
            Assert.AreEqual(currentURL, "http://localhost:61054/Login.aspx");
        ...
        public void EmployeeLoginTest()
        {
            ...
            Assert.AreEqual(currentURL, "http://localhost:61054/EmployeePage.aspx");
